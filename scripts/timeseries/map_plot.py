...
def save_mls(data) -> None:
    ...
    np.save(downloads / "MLS_O3_day_reduced.npy", data, allow_pickle=True)


files = get_files()
mls, mira2 = read_data(files=files, period="night")
plot_map(data=reduce_dict(mls), period="night")
