...
mira2 = read_data(file="/home/ric/Software/git/op/scripts/data/mira2_screened.npy")
mls = read_data(file="/home/ric/Downloads/MLS.O3.reduced.npy")
...
np.save("data/mira2_avks.npy", aks, allow_pickle=True)
np.save("data/mls_matching.npy", mls_matching, allow_pickle=True)
np.save("data/mira2_matching.npy", mira2_matching, allow_pickle=True)
