...
class Plotting:
    ...
    def make_fig01(self, figure):
        ...
        ax.add_patch(
            Rectangle(
                xy=xy["MIRA2"], width=2, height=23, fill=False, edgecolor="red", lw=1
            )
        )
        ax.annotate(
            "MIRA2",
        ...
        ax.add_patch(
            Rectangle(
                xy=xy["R2"], width=17, height=70, fill=False, edgecolor="red", lw=1
            )
        )
        ax.annotate(
            "MLS/Aura R2",
        ...
        ax.add_patch(
            Rectangle(
                xy=xy["R3"], width=12, height=43, fill=False, edgecolor="red", lw=1
            )
        )
        ax.annotate(
            "MLS/Aura R3",
